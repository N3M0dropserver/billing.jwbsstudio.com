/**
 * One source of truth for the primary destinations, shared by the desktop
 * sidebar and the mobile tab bar. `short` is what fits under a thumb-sized
 * tab; `label` is what the sidebar has room for.
 */
...
export const NAV_LINKS: NavLink[] = [
  ...
  { href: '/invoices', label: 'Invoices', short: 'Invoices', icon: 'file' },
  { href: '/clients', label: 'Clients', short: 'Clients', icon: 'users' },
  { href: '/time', label: 'Time', short: 'Time', icon: 'clock' },
  { href: '/tax', label: 'Tax & accounting', short: 'Tax', icon: 'calculator' },
];
