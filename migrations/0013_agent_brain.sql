...
CREATE INDEX `agent_memories_scope_idx` ON `agent_memories` (`user_id`,`scope`,`scope_key`);--> statement-breakpoint
CREATE INDEX `agent_memories_recent_idx` ON `agent_memories` (`user_id`,`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `agent_research_user_idx` ON `agent_research` (`user_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `agent_research_campaign_idx` ON `agent_research` (`campaign_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `agent_research_steps_idx` ON `agent_research_steps` (`research_id`,`step`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `agent_skill_revisions_idx` ON `agent_skill_revisions` (`skill_id`,`version`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `agent_skills_slug_idx` ON `agent_skills` (`user_id`,`slug`);--> statement-breakpoint
CREATE INDEX `agent_skills_status_idx` ON `agent_skills` (`user_id`,`status`);--> statement-breakpoint
